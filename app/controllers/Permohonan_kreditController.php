				...
				if(!$data){
					...
					if($this->checkPost && $this->checkFiles){
						$data_insert = array(
							...
							// data pinjaman
							'status_nasabah' => $this->helper->checkEmpty($data['status_nasabah']) ? NULL : $this->validation->validInput($data['status_nasabah'], false),
							'limit_kredit' => $this->helper->checkEmpty($data['limit_kredit']) ? NULL : $this->validation->validInput($data['limit_kredit'], false),
							'jangka_waktu' => $this->helper->checkEmpty($data['jangka_waktu']) ? NULL : $this->validation->validInput($data['jangka_waktu'], false),
							'tujuan' => $this->helper->checkEmpty($data['tujuan']) ? NULL : $this->validation->validInput($data['tujuan'], false),
							'jelaskan' => $this->helper->checkEmpty($data['jelaskan']) ? NULL : $this->validation->validInput($data['jelaskan'], false),

							// data permohonan
							'nama' => $this->helper->checkEmpty($data['nama']) ? NULL : $this->validation->validInput($data['nama'], false),
							'nama_panggilan' => $this->helper->checkEmpty($data['nama_panggilan']) ? NULL : $this->validation->validInput($data['nama_panggilan'], false),
							'tmpt_lahir' => $this->helper->checkEmpty($data['tmpt_lahir']) ? NULL : $this->validation->validInput($data['tmpt_lahir'], false),
							'tgl_lahir' => $this->helper->checkEmpty($data['tgl_lahir']) ? NULL : $this->validation->validInput($data['tgl_lahir'], false),
							'jk' => $this->helper->checkEmpty($data['jk']) ? NULL : $this->validation->validInput($data['jk'], false),
							'no_ktp' => $this->helper->checkEmpty($data['no_ktp']) ? NULL : $this->validation->validInput($data['no_ktp'], false),
							'berlaku' => $this->helper->checkEmpty($data['berlaku']) ? NULL : $this->validation->validInput($data['berlaku'], false),
							'seumur_hidup' => $this->helper->checkEmpty($data['seumur_hidup']) ? NULL : $this->validation->validInput($data['seumur_hidup'], false),
							'status_kawin' => $this->helper->checkEmpty($data['status_kawin']) ? NULL : $this->validation->validInput($data['status_kawin'], false),
							'jumlah_anak' => $this->helper->checkEmpty($data['jumlah_anak']) ? NULL : $this->validation->validInput($data['jumlah_anak'], false),
							'pendidikan_formal' => $this->helper->checkEmpty($data['pendidikan_formal']) ? NULL : $this->validation->validInput($data['pendidikan_formal'], false),
							'nama_ibu' => $this->helper->checkEmpty($data['nama_ibu']) ? NULL : $this->validation->validInput($data['nama_ibu'], false),
							'alamat' => $this->helper->checkEmpty($data['alamat']) ? NULL : $this->validation->validInput($data['alamat'], false),
							'status_rumah' => $this->helper->checkEmpty($data['status_rumah']) ? NULL : $this->validation->validInput($data['status_rumah'], false),
							'sewa_rumah' => $this->helper->checkEmpty($data['sewa_rumah']) ? NULL : $this->validation->validInput($data['sewa_rumah'], false),
							'no_telp' => $this->helper->checkEmpty($data['no_telp']) ? NULL : $this->validation->validInput($data['no_telp'], false),

							// data suami-istri
							'nama_suami_istri' => $this->helper->checkEmpty($data['nama_suami_istri']) ? NULL : $this->validation->validInput($data['nama_suami_istri'], false),
							'tmpt_lahir_suami_istri' => $this->helper->checkEmpty($data['tmpt_lahir_suami_istri']) ? NULL : $this->validation->validInput($data['tmpt_lahir_suami_istri'], false),
							'tgl_lahir_suami_istri' => $this->helper->checkEmpty($data['tgl_lahir_suami_istri']) ? NULL : $this->validation->validInput($data['tgl_lahir_suami_istri'], false),
							'pekerjaan_suami_istri' => $this->helper->checkEmpty($data['pekerjaan_suami_istri']) ? NULL : $this->validation->validInput($data['pekerjaan_suami_istri'], false),

							'pilih_pekerjaan' => $this->helper->checkEmpty($data['pilih_pekerjaan']) ? NULL : $this->validation->validInput($data['pilih_pekerjaan'], false),

							// data pekerjaan
							'pekerjaan' => $this->helper->checkEmpty($data['pekerjaan']) ? NULL : $this->validation->validInput($data['pekerjaan'], false),
							'bidang_usaha_pekerjaan' => $this->helper->checkEmpty($data['bidang_usaha_pekerjaan']) ? NULL : $this->validation->validInput($data['bidang_usaha_pekerjaan'], false),
							'lama_bekerja' => $this->helper->checkEmpty($data['lama_bekerja']) ? NULL : $this->validation->validInput($data['lama_bekerja'], false),
							'nama_perusahaan' => $this->helper->checkEmpty($data['nama_perusahaan']) ? NULL : $this->validation->validInput($data['nama_perusahaan'], false),
							'jabatan' => $this->helper->checkEmpty($data['jabatan']) ? NULL : $this->validation->validInput($data['jabatan'], false),
							'alamat_perusahaan' => $this->helper->checkEmpty($data['alamat_perusahaan']) ? NULL : $this->validation->validInput($data['alamat_perusahaan'], false),
							'no_telp_perusahaan' => $this->helper->checkEmpty($data['no_telp_perusahaan']) ? NULL : $this->validation->validInput($data['no_telp_perusahaan'], false),
							'penghasilan_bersih_pekerjaan' => $this->helper->checkEmpty($data['penghasilan_bersih_pekerjaan']) ? NULL : $this->validation->validInput($data['penghasilan_bersih_pekerjaan'], false),
							'rata2_biaya_hidup' => $this->helper->checkEmpty($data['rata2_biaya_hidup']) ? NULL : $this->validation->validInput($data['rata2_biaya_hidup'], false),

							// data pekerjaan - usaha
							'bentuk_usaha' => $this->helper->checkEmpty($data['bentuk_usaha']) ? NULL : $this->validation->validInput($data['bentuk_usaha'], false),
							'prosentase_kepemilikan' => $this->helper->checkEmpty($data['prosentase_kepemilikan']) ? NULL : $this->validation->validInput($data['prosentase_kepemilikan'], false),
							'usaha_sejak' => $this->helper->checkEmpty($data['usaha_sejak']) ? NULL : $this->validation->validInput($data['usaha_sejak'], false),
							'bidang_usaha' => $this->helper->checkEmpty($data['bidang_usaha']) ? NULL : $this->validation->validInput($data['bidang_usaha'], false),
							'jumlah_karyawan' => $this->helper->checkEmpty($data['jumlah_karyawan']) ? NULL : $this->validation->validInput($data['jumlah_karyawan'], false),
							'alamat_usaha' => $this->helper->checkEmpty($data['alamat_usaha']) ? NULL : $this->validation->validInput($data['alamat_usaha'], false),
							'no_telp_usaha' => $this->helper->checkEmpty($data['no_telp_usaha']) ? NULL : $this->validation->validInput($data['no_telp_usaha'], false),
							'penghasilan_bersih' => $this->helper->checkEmpty($data['penghasilan_bersih']) ? NULL : $this->validation->validInput($data['penghasilan_bersih'], false),
							
							// data agunan
							'jenis' => $this->helper->checkEmpty($data['jenis']) ? NULL : $this->validation->validInput($data['jenis'], false),
							'tipe_kendaraan' => $this->helper->checkEmpty($data['tipe_kendaraan']) ? NULL : $this->validation->validInput($data['tipe_kendaraan'], false),
							'warna' => $this->helper->checkEmpty($data['warna']) ? NULL : $this->validation->validInput($data['warna'], false),
							'tahun' => $this->helper->checkEmpty($data['tahun']) ? NULL : $this->validation->validInput($data['tahun'], false),
							'no_bpkb' => $this->helper->checkEmpty($data['no_bpkb']) ? NULL : $this->validation->validInput($data['no_bpkb'], false),
							'atas_nama' => $this->helper->checkEmpty($data['atas_nama']) ? NULL : $this->validation->validInput($data['atas_nama'], false),
							'status_agunan' => $this->helper->checkEmpty($data['status_agunan']) ? NULL : $this->validation->validInput($data['status_agunan'], false),
							'imb' => $this->helper->checkEmpty($data['imb']) ? NULL : $this->validation->validInput($data['imb'], false),
							'ada' => $this->helper->checkEmpty($data['ada']) ? NULL : $this->validation->validInput($data['ada'], false),
							'alamat_agunan' => $this->helper->checkEmpty($data['alamat_agunan']) ? NULL : $this->validation->validInput($data['alamat_agunan'], false),

							// data keluarga
							'nama_keluarga' => $this->helper->checkEmpty($data['nama_keluarga']) ? NULL : $this->validation->validInput($data['nama_keluarga'], false),
							'alamat_keluarga' => $this->helper->checkEmpty($data['alamat_keluarga']) ? NULL : $this->validation->validInput($data['alamat_keluarga'], false),
							'no_telp_keluarga' => $this->helper->checkEmpty($data['no_telp_keluarga']) ? NULL : $this->validation->validInput($data['no_telp_keluarga'], false),
							'hubungan_keluarga' => $this->helper->checkEmpty($data['hubungan_keluarga']) ? NULL : $this->validation->validInput($data['hubungan_keluarga'], false),
