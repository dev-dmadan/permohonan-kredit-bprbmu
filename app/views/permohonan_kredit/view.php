...
<div class="content-wrapper">
	...
	<section class="content container-fluid">
		...
		<input type="hidden" id="type" value="<?= strtolower($this->data['pilih_pekerjaan']); ?>">
		<div class="row">
				...
				<div class="box">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="btn-group">
									...
									<!-- kembali -->
									<button type="button" class="btn btn-default btn-flat" id="kembali"><i class="fa fa-back"></i> Kembali</button>
								</div>
							</div>
						</div>
					</div>
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-12">
								<fieldset>
									<legend style="font-size: 18px;">Data File Upload</legend>
									<table class="table table-hover">
										<tbody>
											<!-- File KTP Pemohon -->
											<tr>
