...
<div class="row">
	<div class="col-md-6 col-xs-12">
		<!-- KTP Pemohon -->
		<div class="form-group field-file_ktp_pemohon has-feedback">
		...
		<!-- KTP Suami / Istri -->
		<div class="form-group field-file_ktp_suami_istri has-feedback">
		...
		<!-- Kartu Keluarga -->
		<div class="form-group field-file_kk has-feedback">
		...
		<!-- Slip Gaji -->
		<div class="form-group field-file_slip_gaji has-feedback">
	...
	<div class="col-md-6 col-xs-12">
		<!-- STNK -->
		<div class="form-group field-file_stnk has-feedback">
		...
		<!-- Nota Pajak -->
		<div class="form-group field-file_nota_pajak has-feedback">
		...
		<!-- Faktur -->
		<div class="form-group field-file_faktur has-feedback">
		...
		<!-- Kwintasi Jual Beli -->
		<div class="form-group field-file_kwintasi_jual_beli has-feedback">
